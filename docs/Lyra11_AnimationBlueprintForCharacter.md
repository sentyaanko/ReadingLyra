...
Manny (無印)と Quinn (_Feminine 付き)は継承関係ではなく、基本的に兄弟になっています。  
...
| `ABP_Manny_PostProcess`			| Manny の ポストプロセス用の ABP です。														|
| `ABP_Quinn_PostProcess`			| Quinn の ポストプロセス用の ABP です。														|
